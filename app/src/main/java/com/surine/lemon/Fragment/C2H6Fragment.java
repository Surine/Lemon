...
public class C2H6Fragment extends Fragment {
    LineChart chart;
    int tag = 1;
    private static final String ARG_ ="C2H6Fragment" ;
    View v;
    public static C2H6Fragment getInstance(String title) {
        C2H6Fragment fra = new C2H6Fragment();
